...
<img src="image/README/2.png" alt="Alt text" width="350" height="300">
5. You can name as `icse` and click `save`:
<img src="image/README/3.png" alt="Alt text" width="350" height="300">
...
<img src="image/README/4.png" alt="Alt text" width="350" height="300">
7. Once import is done, click `ok` on this pop-up:
<img src="image/README/5.png" alt="Alt text" width="350" height="300">
8. If you see this pop-up, then just enter `0000` (four time zero digit) as a code:
<img src="image/README/6.png" alt="Alt text" width="350" height="300">
9. Open VS code from side dock.
10. Open Folder, present in `Downloads/icse`:
<img src="image/README/7.png" alt="Alt text" width="350" height="300">
11. Open the terminal and activate the conda environment `conda activate icse`:
<img src="image/README/8.png" alt="Alt text" width="350" height="300">
...
<img src="image/README/9.png" alt="Alt text" width="350" height="300">
13. After successfull run, you will see the following output on terminal:
<img src="image/README/10.png" alt="Alt text" width="350" height="300">
